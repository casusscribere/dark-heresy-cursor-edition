...
export class DarkHeresyItem extends DarkHeresyItemContainer {
    ...
    async _determineNestedItems() {
        ...
        if (this.system.special) {
            ...
            if (this.isWeapon) await this._updateSpecialsFromPack('dark-heresy-3rd-edition.weapons', this.system.special);
            if (this.isAmmunition) await this._updateSpecialsFromPack('dark-heresy-3rd-edition.ammo', this.system.special);
    ...
    async _getAttackSpecials(specialData) {
        const attackSpecialPack = game.packs.find((p) => p.collection === 'dark-heresy-3rd-edition.attack-specials');
