...
import { registerDataModels } from './models/data-models.mjs';

import * as documents from './documents/_module.mjs'

export const SYSTEM_ID = 'dark-heresy-3rd-edition';
...
`);
        ...
        // Register sheet application classes (DocumentSheetConfig in V14, legacy fallback for older clients).
        const sheetConfig = foundry?.applications?.apps?.DocumentSheetConfig;
        if (sheetConfig?.registerSheet) {
            sheetConfig.registerSheet(Actor, SYSTEM_ID, AcolyteSheet, { types: ["acolyte"], makeDefault: true });
            sheetConfig.registerSheet(Actor, SYSTEM_ID, NpcSheet, { types: ['npc'], makeDefault: true });
            sheetConfig.registerSheet(Actor, SYSTEM_ID, VehicleSheet, { types: ['vehicle'], makeDefault: true });

            sheetConfig.registerSheet(Item, SYSTEM_ID, DarkHeresyItemSheet, { makeDefault: true });
            sheetConfig.registerSheet(Item, SYSTEM_ID, DarkHeresyAmmoSheet, { types: ['ammunition'], makeDefault: true });
            sheetConfig.registerSheet(Item, SYSTEM_ID, DarkHeresyArmourSheet, { types: ['armour'], makeDefault: true });
            sheetConfig.registerSheet(Item, SYSTEM_ID, DarkHeresyAttackSpecialSheet, { types: ['attackSpecial'], makeDefault: true });
            sheetConfig.registerSheet(Item, SYSTEM_ID, DarkHeresyCriticalInjurySheet, { types: ['criticalInjury'], makeDefault: true });
            sheetConfig.registerSheet(Item, SYSTEM_ID, DarkHeresyCyberneticSheet, { types: ['cybernetic'], makeDefault: true });
            sheetConfig.registerSheet(Item, SYSTEM_ID, DarkHeresyJournalEntrySheet, { types: ['journalEntry'], makeDefault: true });
            sheetConfig.registerSheet(Item, SYSTEM_ID, DarkHeresyForceFieldSheet, { types: ['forceField'], makeDefault: true });
            sheetConfig.registerSheet(Item, SYSTEM_ID, DarkHeresyGearSheet, { types: ['consumable', 'gear', 'drug', 'tool'], makeDefault: true });
            sheetConfig.registerSheet(Item, SYSTEM_ID, DarkHeresyPeerEnemySheet, { types: ['peer', 'enemy'], makeDefault: true });
            sheetConfig.registerSheet(Item, SYSTEM_ID, DarkHeresyPsychicPowerSheet, { types: ['psychicPower'], makeDefault: true });
            sheetConfig.registerSheet(Item, SYSTEM_ID, DarkHeresyStorageLocationSheet, { types: ['storageLocation'], makeDefault: true });
            sheetConfig.registerSheet(Item, SYSTEM_ID, DarkHeresyTalentSheet, { types: ['talent'], makeDefault: true });
            sheetConfig.registerSheet(Item, SYSTEM_ID, DarkHeresyTraitSheet, { types: ['trait'], makeDefault: true });
            sheetConfig.registerSheet(Item, SYSTEM_ID, DarkHeresyWeaponModSheet, { types: ['weaponModification'], makeDefault: true });
            sheetConfig.registerSheet(Item, SYSTEM_ID, DarkHeresyWeaponSheet, { types: ['weapon'], makeDefault: true });
        } else {
