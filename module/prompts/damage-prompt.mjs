...
export async function prepareDamageRoll(rollData) {
    ...
    const html = await renderTemplate('systems/dark-heresy-3rd-edition/templates/prompt/damage-roll-prompt.hbs', rollData);
            ...
            buttons: {
                roll: {
                    ...
                    callback: async (html) => {
                        ...
                        actionData.template = 'systems/dark-heresy-3rd-edition/templates/chat/damage-roll-chat.hbs';
                        ...
                        rollData.template = 'systems/dark-heresy-3rd-edition/templates/chat/damage-roll-chat.hbs';
