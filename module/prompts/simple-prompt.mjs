...
export async function prepareSimpleRoll(simpleSkillData) {
    const html = await renderTemplate('systems/dark-heresy-3rd-edition/templates/prompt/simple-roll-prompt.hbs', simpleSkillData);
...
export async function prepareCreateSpecialistSkillPrompt(simpleSkillData) {
    const html = await renderTemplate('systems/dark-heresy-3rd-edition/templates/prompt/add-speciality-prompt.hbs', simpleSkillData);
    let dialog = new Dialog(
        {
