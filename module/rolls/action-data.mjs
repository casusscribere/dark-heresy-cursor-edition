...
export class WeaponActionData extends ActionData {
    constructor() {
        super();
        this.template = 'systems/dark-heresy-3rd-edition/templates/chat/action-roll-chat.hbs';
        this.hasDamage = true;
...
export class PsychicActionData extends ActionData {
    ...
    async performActionAndSendToChat() {
        if(!this.rollData.hasDamage) {
            this.rollData.template = 'systems/dark-heresy-3rd-edition/templates/chat/psychic-action-chat.hbs';
            this.template = 'systems/dark-heresy-3rd-edition/templates/chat/psychic-action-chat.hbs';
        }
...
export class SimpleSkillData extends ActionData {
    constructor() {
        super();
        this.template = 'systems/dark-heresy-3rd-edition/templates/chat/simple-roll-chat.hbs';
        this.hasDamage = false;
